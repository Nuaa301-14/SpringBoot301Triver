...
import com.example.javacrawler.task.pipeline.CrawlScenicHotelTCPipeline;
...
public class CrawlScenicHotelTC implements PageProcessor {
    private int max;
    ...
    public void craw(String url, int pageNum, CrawlScenicHotelTCPipeline crawlScenicHotelTCPipeline) {
        max=pageNum;
        Spider.create(new CrawlScenicHotelTC()).addUrl(url)
                ...
                .addPipeline(crawlScenicHotelTCPipeline)
                .run();
    }
}
