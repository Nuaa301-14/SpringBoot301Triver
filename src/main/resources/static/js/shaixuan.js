...
oSelectList.onclick = function (e, a) {
    ...
    if (a && a == 2) {
        ...
        if (radioVal) {
            infor += '<div class=\"selectedInfor selectedShow\"><span>酒店价格</span><label>' + radioVal + '</label><em p="2"></em></div>';
            price = "酒店价格|" + radioVal;
        }
    }
    ...
    for (var i = 0,
        ...
        conditions.push(vals[1] + "|" + vals[0]);
    }
    console.log(conditions);
    console.log("price="+price)
    $("#showAllTag").html(infor);
    // oClearList.html(infor);
    console.log(infor);
};
$('div.eliminateCriteria').click(function () {
    console.log("click eliminateCriteria");
